...
any of the four keys on each trial. Unfortunately, the prepotent response
to respond "left" when something appears on the left was responsible for many 
people to responding to the location of the printed word rather than
it's identity, which required an up or down response.

The analysis of RTs below includes only the correct responses, so any trial
in which there was a wrong button press is not included.
