...
We conducted Experiment 2C to rule out the possibility that visual interference
disrupts task performance in general, regardless of the specificity of the
visual interference effects. In this experiment we had participants perform
a dual task. On some trials participants completed the same upright picture
detection task as performed in Experiments 2A and 2B. On other trials 
participants performed a word repetition task which does not require the
visual knowledge. We expected visual interference to again disrupt the
verbal cueing effect observed in Experiments 2A and 2B, but not to
have an effect on word repetition detection.
